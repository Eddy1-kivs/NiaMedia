  ...
  return _c(
    ...
    [
      _c("Head", [
        ...
        _vm._v(" "),
        _c("meta", {
          attrs: { name: "description", content: " nia media - contact" },
        }),
      ]),
      _vm._v(" "),
      _c(
        ...
        [
          _c(
            "v-img",
            { attrs: { src: "/images/about2.png", "max-height": "250" } },
            [
              _c(
                "div",
                {
                  staticClass:
                    "text-5xl font-bold text-center white--text mt-[100px]",
                },
                [_vm._v("\n        Contact Us\n      ")]
              ),
            ]
              ...
              _c(
                ...
                [
                  _c(
                    "v-card",
                    [
                      _c("v-card-title", { staticClass: "pb-8" }, [
                        _c("div", { staticClass: "text-3xl font-bold" }, [
                          _vm._v("Ask for your query"),
                        ]),
                      ]),
                      _vm._v(" "),
                      _c("v-card-text", [
                          ...
                          _vm._l(_vm.contactItems, function (contact, index) {
                            return _c(
                              ...
                              [
                                ...
                                _vm._v(" "),
                                index + 1 != _vm.contactItems.length
